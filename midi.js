        ...
        return (
          ...
          (t.prototype.ticksToMeasures = function (t) {
            ...
            if (-1 !== e) {
              ...
              return (
                r.measures + i / (r.timeSignature[0] / r.timeSignature[1]) / 4
              );
            }
            return t / this.ppq / 4;
          }),
        ...
        h = (function () {
          ...
          return (
            (t.prototype.addNote = function (t) {
              ...
              return (
                Object.assign(r, t), n.insert(this.notes, r, "ticks"), this
              );
            }),
            ...
            (t.prototype.addPitchBend = function (t) {
              var e = u.get(this),
                r = new o.PitchBend({}, e);
              return (
                Object.assign(r, t), n.insert(this.pitchBends, r, "ticks"), this
              );
            }),
            ...
            switch (i) {
              case 0:
                if (((t.type = "sequenceNumber"), 2 !== a))
                  throw (
                    "Expected length for sequenceNumber event is 2, got " + a
                  );
              ...
              case 2:
                return (
                  (t.type = "copyrightNotice"), (t.text = r.readString(a)), t
                );
              case 3:
                return (t.type = "trackName"), (t.text = r.readString(a)), t;
              case 4:
                return (
                  (t.type = "instrumentName"), (t.text = r.readString(a)), t
                );
              case 5:
              ...
              case 127:
                return (
                  (t.type = "sequencerSpecific"), (t.data = r.readBytes(a)), t
                );
              default:
                return (
                  (t.type = "unknownMeta"),
                  (t.data = r.readBytes(a)),
                  (t.metatypeByte = i),
                  t
                );
            }
          ...
          for (
            var a = (function (t) {
                var e = new n(t),
                  ...
                  o = e.readUInt16();
                32768 & o
                  ? ((a.framesPerSecond = 256 - (o >> 8)),
                    (a.ticksPerFrame = 255 & o))
                  : (a.ticksPerBeat = o);
                return a;
              })(i.data),
              o = [],
    ...
    function (t, e) {
      function r(t, e, r) {
        var a,
          ...
          c = null;
        for (a = 0; a < s; a++)
          (!1 !== r.running && (r.running || e[a].running)) || (c = null),
            (c = n(o, e[a], c, r.useByte9ForNoteOff));
      ...
      function n(t, e, r, n) {
        ...
        switch ((t.writeVarInt(a), i)) {
          ...
          case "noteOff":
            (c =
              ((!1 !== n && e.byte9) || (n && 0 == e.velocity) ? 144 : 128) |
              e.channel) !== r && t.writeUInt8(c),
